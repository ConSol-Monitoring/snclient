...
var procGetNativeSystemInfo = utils.Modkernel32.NewProc("GetNativeSystemInfo")
...
type win32_SystemProcessorPerformanceInformation struct { //nolint:revive //FIXME
	...
	InterruptCount uint64 // Windows Type ULONG is 64Bit  = 8 byte missing 4 bytes in size
}
...
func TimesWithContext(_ context.Context, percpu bool) ([]TimesStat, error) {
	...
	var ret []TimesStat
	var lpIdleTime utils.FILETIME
	var lpKernelTime utils.FILETIME
	var lpUserTime utils.FILETIME
	r, _, _ := utils.ProcGetSystemTimes.Call(
...
func InfoWithContext(ctx context.Context) ([]InfoStat, error) {
	...
	if err := utils.WMIQueryWithContext(ctx, q, &dst); err != nil {
		return ret, err
	}
...
func perfInfo() ([]win32_SystemProcessorPerformanceInformation, error) {
	...
	retCode, _, err := utils.ProcNtQuerySystemInformation.Call(
