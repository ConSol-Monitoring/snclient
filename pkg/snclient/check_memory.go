...
read more on windows virtual address space:
    ...
    https://learn.microsoft.com/en-us/windows/win32/api/sysinfoapi/ns-sysinfoapi-memorystatusex`,
		...
		args: map[string]CheckArgument{
			"type": {value: &l.memType, description: "Types of memory to check. Default: physical,committed (win) or physical,swap (other)."},
		},
...
func (l *CheckMemory) Check(_ context.Context, snc *Agent, check *CheckData, _ []Argument) (*CheckResult, error) {
