...
// TokenizeShell returns list of string tokens as
// they would be used by a shell (no quotes around anymore)
func TokenizeShell(str string) ([]string, error) {
	var tokens []string
	separator := " \t\n\r"
	...
	if inDbl || inQuotes {
		return tokens, fmt.Errorf("unbalanced quotes")
	}
